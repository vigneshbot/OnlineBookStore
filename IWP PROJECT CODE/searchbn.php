...
<html>
    ...
    <?php endif ?></li>
		...
		<h2 style="font-family: Lucida Calligraphy; padding-top:35px;">Enter the Name of the book: </h2>
		<form method="post" action="searchbn.php">
		<input type="text" id="search" name="search" placeholder="What book are you looking for?">
		<button type="submit" name="searchbn" id="searchbtn"><i class="fa fa-search"></i></button></form><br><br>
		...
		<?php
				...
				$sql = "SELECT bookname, imglink,link FROM books WHERE bookname='$bookname'";
