...
<html>
    ...
    <?php endif ?></li>
		...
		<h2 style="font-family: Lucida Calligraphy; padding-top:35px;">Enter an year: </h2>
		<form method="post" action="searchy.php">
		<input type="text" id="search" name="search" placeholder="Which year's books are you looking for?">
		<button type="submit" id="searchbtn" name="searchy"><i class="fa fa-search"></i></button></form><br><br>
		...
		<?php
				...
				$year =$_POST['search'];
				$sql = "SELECT bookname, imglink,link FROM books WHERE year='$year'";
